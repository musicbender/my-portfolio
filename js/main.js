...
/*******adds SVG code for work sample items. Removes DRY code from HTML*******/
    ...
    const captionSvg2 = '<svg class="bigTriangleColor mobile caption-triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100" viewBox="0 0 100 101" preserveAspectRatio="none"><path d="M0 100 L25 0 L100 100 Z" /></svg>';


    $caption.prepend(captionSvg);
    $captionMobile.prepend(captionSvg2);
    $('.bigTriangleColor.mobile').css('display', 'none');
